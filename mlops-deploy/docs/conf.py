...
latex_documents = [
    ('index',
     ...
     u"Heryck_Klemerson_Daniel_Leonardo", 'manual'),
]
...
man_pages = [
    ('index', 'mlops-deploy', u'mlops-deploy Documentation',
     [u"Heryck_Klemerson_Daniel_Leonardo"], 1)
]
...
texinfo_documents = [
    ('index', 'mlops-deploy', u'mlops-deploy Documentation',
     u"Heryck_Klemerson_Daniel_Leonardo", 'mlops-deploy',
     'trabalho_data_science_para_negocios', 'Miscellaneous'),
]
